"""
Source code from
https://github.com/ZhixiuYe/MLMAN/blob/master/models/MLMAN.py
...
import sentence_encoder.embedding as embedding
...
class MLMAN(nn.Module):
    ...
    def __init__(self, word_vec_mat, max_length, word_embedding_dim=50, pos_embedding_dim=5, args=None,
        ...
        self.lstm_enhance = nn.LSTM(input_size=self.hidden_size, hidden_size=self.hidden_size, bidirectional=True,
                                    batch_first=True)
